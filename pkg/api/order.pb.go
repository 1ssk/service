...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\x03api\x1a\x1cgoogle/api/annotations.proto\"G\n" +
	"\x05Order\x12\x0e\n" +
	...
	".api.OrderR\x06orders2\xc5\x03\n" +
	"\fOrderService\x12W\n" +
	"\vCreateOrder\x12\x17.api.CreateOrderRequest\x1a\x18.api.CreateOrderResponse\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/api/order\x12P\n" +
	"\bGetOrder\x12\x14.api.GetOrderRequest\x1a\x15.api.GetOrderResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/api/order/{id}\x12\\\n" +
	"\vUpdateOrder\x12\x17.api.UpdateOrderRequest\x1a\x18.api.UpdateOrderResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\x1a\x0f/api/order/{id}\x12Y\n" +
	"\vDeleteOrder\x12\x17.api.DeleteOrderRequest\x1a\x18.api.DeleteOrderResponse\"\x17\x82\xd3\xe4\x93\x02\x11*\x0f/api/order/{id}\x12Q\n" +
	"\n" +
	"ListOrders\x12\x16.api.ListOrdersRequest\x1a\x17.api.ListOrdersResponse\"\x12\x82\xd3\xe4\x93\x02\f\x12\n" +
	"/api/orderB\tZ\apkg/apib\x06proto3"
